...
const PrivacyVeil: React.FC = () => {
  ...
  useEffect(() => {
    ...
    update(); // Initial call
    const timerId = setInterval(update, 1000); // Update every second
  ...
  return (
    ...
    >
        <div className="w-full max-w-lg text-left pt-12">
            ...
            <ul className="list-disc list-inside space-y-1 text-lg text-slate-600 mb-3">
